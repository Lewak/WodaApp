...
import com.example.wodasyf.databinding.AddNewAlarmBinding
...
class CreateNewAlarm : Fragment() {
    ...
    private var _binding: AddNewAlarmBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = AddNewAlarmBinding.inflate(inflater, container, false)
        createSpinner()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.createButton.setOnClickListener {
            val tempAlarm = Alarm()
                ...
                alarmList.saveAlarm(tempAlarm)
                findNavController().navigate(R.id.action_createNewAlarm_to_SecondFragment)
